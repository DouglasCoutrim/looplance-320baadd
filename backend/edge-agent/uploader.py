...
def upload_clip(settings: Settings, *, arena_id: str, quadra_id: str, replay_id: str, file_path: Path) -> tuple[str, str, int]:
    """
    Convenção de chave (spec 4.2): replays/<arena_id>/<quadra_id>/<yyyy-mm-dd>/<replay_id>.mp4
