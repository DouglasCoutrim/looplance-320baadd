  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-brand selection:text-white">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 pt-10 pb-24">
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-left-8 duration-700">
            ...
            <div className="grid grid-cols-2 gap-6 pt-4">
              <div className="space-y-2 group">
                <div className="h-12 w-12 rounded-2xl bg-white/10 flex items-center justify-center text-brand-orange group-hover:brand-gradient group-hover:text-white transition-all duration-300">
                  <Play className="h-6 w-6" />
                </div>
                <h3 className="font-black uppercase tracking-tight text-sm">Tempo Real</h3>
                <p className="text-xs text-white/50 leading-tight">Lances processados em segundos direto da quadra.</p>
              </div>
              <div className="space-y-2 group">
                <div className="h-12 w-12 rounded-2xl bg-white/10 flex items-center justify-center text-brand-orange group-hover:brand-gradient group-hover:text-white transition-all duration-300">
                  <Share2 className="h-6 w-6" />
                </div>
                <h3 className="font-black uppercase tracking-tight text-sm">Fácil de Compartilhar</h3>
                <p className="text-xs text-white/50 leading-tight">Direto para o seu Instagram, WhatsApp ou Galeria.</p>
              </div>
              <div className="space-y-2 group">
                <div className="h-12 w-12 rounded-2xl bg-white/10 flex items-center justify-center text-brand-orange group-hover:brand-gradient group-hover:text-white transition-all duration-300">
                  <Smartphone className="h-6 w-6" />
                </div>
                <h3 className="font-black uppercase tracking-tight text-sm">App Mobile First</h3>
                <p className="text-xs text-white/50 leading-tight">Interface otimizada para ser usada entre os sets.</p>
              </div>
              <div className="space-y-2 group">
                <div className="h-12 w-12 rounded-2xl bg-white/10 flex items-center justify-center text-brand-orange group-hover:brand-gradient group-hover:text-white transition-all duration-300">
                ...
                <p className="text-xs text-white/50 leading-tight">Processamento local seguro e replays exclusivos.</p>
              </div>
            </div>

            <div className="pt-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-[10px] font-black uppercase tracking-widest text-brand-orange">
        ...
        {/* Footer Propaganda */}
        <footer className="mt-32 pt-16 border-t border-white/10 grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4 md:col-span-2 flex flex-col justify-center">
            <h4 className="text-xs font-black uppercase tracking-widest text-white/40">Para Donos de Arena</h4>
            <div className="flex flex-wrap gap-4">
              <a href="#" className="px-6 py-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition text-sm font-bold">
