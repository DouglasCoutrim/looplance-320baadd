...
export const MobileBottomNav = () => {
  ...
  return (
    <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[390px] bg-[#F97316] h-[calc(70px+env(safe-area-inset-bottom,16px))] rounded-t-[24px] px-4 flex items-start justify-around pt-3 safe-area-bottom z-50">
      {navItems.map((item) => {
