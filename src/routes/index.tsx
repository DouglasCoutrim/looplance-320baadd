...
function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      {/* Header */}
      <header className="sticky top-0 z-40 border-b border-white/10 bg-black py-2 shadow-xl">
        <div className="mx-auto flex max-w-2xl items-center px-6">
          ...
          <div className="flex-none">
            <img src={logoUrl} alt="Looplance" className="h-20 w-auto transition-transform hover:scale-105" />
          </div>
